...
- Real production-log conversion is deferred until a public source contract, caller-supplied redaction hooks, privacy guidance, and safe fixture coverage exist. Use canonical or documented external dataset formats instead.
