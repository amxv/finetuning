...
## 0.0.0-alpha foundations

- Added canonical chat datasets, formats, orchestration, response distillation, and the versioned TypeScript-to-Python training contract.
